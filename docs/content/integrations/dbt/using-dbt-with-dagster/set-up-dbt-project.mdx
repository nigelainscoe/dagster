...
- [Configure it to run with DuckDB](#step-2-configure-it-to-run-with-duckdb)
...
3. Finally, download the sample dbt project into that folder. This step requires git to be installed on your computer. If it's not already installed, you can install it using the [intructions on the git website](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git).
...
## Step 2: Configure it to run with DuckDB
