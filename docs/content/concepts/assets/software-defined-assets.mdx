...
If you want Dagit to contain both assets and [jobs](/concepts/ops-jobs-graphs/jobs) that target the assets, you can place the assets and jobs together inside a <PyObject object="Definitions" /> object. For example:
...
<!-- ![Asset catalog page in Dagit](/images/concepts/dagit/all-assets.png) -->

<Image
alt="Asset catalog page in Dagit"
...
<!-- ![Asset details page in Dagit](/images/concepts/dagit/asset.png) -->

<Image
alt="Asset details page in Dagit"
...
<!-- ![Asset lineage graph](/images/concepts/assets/software-defined-assets/graph.png) -->
...
To view your asset groups in Dagit, open the left navigation by clicking the **menu icon in the top left corner**. As asset groups are grouped in code locations, you may need to open a code location to view its asset groups.
