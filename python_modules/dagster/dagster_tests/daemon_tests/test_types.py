...
def test_error_backcompat():
    old_heartbeat = (
        '{"__class__": "DaemonHeartbeat", "daemon_id": "foobar", "daemon_type": {"__enum__":'
...
def test_heartbeat_backcompat():
    old_heartbeat = (
        '{"__class__": "DaemonHeartbeat", "daemon_id": "05f24887-fb6a-4821-807b-fbd772a921e3",'
...
def test_run_status_sensor_cursor_backcompat():
    old_cursor = (
        '{"__class__": "PipelineSensorCursor", "record_id": 20585, "update_timestamp":'
